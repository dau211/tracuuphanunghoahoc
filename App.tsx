...
import { BeakerIcon, VideoIcon, SearchIcon, ClipboardCheckIcon, BrainIcon, PlusIcon } from './components/icons';
...
const App: React.FC = () => {
  ...
  // Helper to render chemical formulas with subscripts in labels
  const renderChemicalLabel = (text: string) => {
  ...
  const ResultDisplay: React.FC<{ result: ReactionData }> = ({ result }) => (
    <div className="mt-8 space-y-6 animate-fade-in w-full">
        ...
        <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 shadow-lg">
            ...
            <p className="text-slate-300 mb-4 font-mono bg-slate-700/50 px-3 py-1.5 rounded-md inline-block text-lg">{lastReactants}</p>
            <div
                ...
                <form onSubmit={handleLookup} className="space-y-6 animate-fade-in">
                    <div className="text-center mb-4">
                        ...
                        <p className="text-sm text-slate-400">
                            Nhập chất (VD: Iron, HNO3...). Nếu phản ứng phụ thuộc điều kiện, hãy ghi rõ (VD: HNO3 đặc/nóng) để có kết quả chính xác nhất.
                        </p>
                    </div>
                    <div className="flex flex-col items-center gap-4">
                        <input
                            ...
                            placeholder="VD: Fe + HCl (hoặc Sắt + Axit clohidric)"
            ...
            {activeTab === 'check' && (
                <form onSubmit={handleCheck} className="space-y-6 animate-fade-in">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <div className="text-3xl font-bold text-slate-400 transform sm:rotate-0 rotate-90 mt-5">→</div>
                        <div className="w-full">
                            ...
                            <div className="flex flex-col items-center gap-6 bg-slate-900/50 p-4 sm:p-6 rounded-xl border border-slate-700/50">
                                ...
                                <div className="w-full text-center">
                                    ...
                                    <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 p-4 bg-slate-800 rounded-lg border border-slate-600">
                                         ...
                                         <div className="flex-grow min-w-[150px]">
                                            <input
                                                ...
                                                placeholder="Sản phẩm & hệ số (VD: 2Al2O3)"
                                    ...
                                    <p className="text-xs text-slate-500 mt-2 italic">
                                        Mẹo: Để trống ô hệ số được hiểu là 1.
                                    </p>
                                </div>
                            </div>
